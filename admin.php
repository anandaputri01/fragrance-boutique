...
<head>
    ...
    <title>Ananda's Fragrance Boutique | Admin</title>
...
<body>
    ...
    <section id="content" class="p-5">
        <div class="container"> 
            ...
            if(isset($_GET['page'])){
            ?>
                <h4 class="lead display-6 pb-2 border-bottom border-warning"><?= ucfirst($_GET['page'])?></h4>
                <?php
    ...
    <div>
        <a href="https://www.instagram.com/anandaaaassss"
    ...
    <div>Ananda's Fragrance Boutique &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
